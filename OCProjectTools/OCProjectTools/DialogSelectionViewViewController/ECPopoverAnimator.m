...
@interface ECPopoverAnimator ()
{
    BOOL                       _isPresented;
    CGSize                     _presentedSize;
}
@property(nonatomic,strong) ECPresentationController  *presentationController;
@property(nonatomic,copy)  ECCompleteBlock          completeBlock;
@property(nonatomic,assign) ECPopoverType              popoverType;
@property(nonatomic,assign) CGFloat                    presentedHeight;
@end

@implementation ECPopoverAnimator

+ (instancetype)popoverAnimatorWithStyle:(ECPopoverType )popoverType completeHandle:(ECCompleteBlock)completeBlock{
    ECPopoverAnimator *popoverAnimator = [[ECPopoverAnimator alloc] init];
    popoverAnimator.popoverType = popoverType;
    popoverAnimator.completeBlock = completeBlock;
    return popoverAnimator;
}

#pragma mark - <UIViewControllerTransitioningDelegatere>
- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source{
    ECPresentationController *presentation = [[ECPresentationController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
...
- (nullable id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source{
    _isPresented = YES;
    !self.completeBlock?:self.completeBlock(_isPresented);
    return self;
}
...
- (void)animationForPresentedView:(nonnull id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    ECWeakSelf(weakSelf)
    if (self.popoverType == ECPopoverTypeAlert) {
